...
const { info, info_container, info_top, info_wrapper } = intro;
...
class Header extends React.Component {
  ...
  /*
  * This section of code was to try conditional render based on the state 
  * of bool: LoggedIn, which updates under the condition that prerrequisites are met.
  ...
  */
  ...
  // Display messages
  DatetimeMessage = () => <h5> {this.state.message} </h5>;
  ...
  // To handle toggle between dark and light modes.
  toggleLightMode = () => {
